...
st.markdown("""
    ...
    /* Background gradient cho app */
    .main { 
        background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); 
    }

    /* --- FIX LỖI HIỂN THỊ CHỮ (QUAN TRỌNG) --- */
    /* 1. Ẩn chữ lỗi ở nút đóng/mở Sidebar */
    [data-testid="stSidebarCollapse"] div div {
        display: none !important;
    }
    
    /* 2. Ẩn chữ lỗi ở Menu cài đặt góc phải (Light/Dark mode) */
    .st-emotion-cache-17686p6, [data-testid="stStatusWidget"] {
        font-size: 0px !important;
    }

    /* 3. Ẩn các icon bị lỗi font chữ */
    span[data-testid="stIconMaterial"] {
        display: none !important;
    }
    /* ---------------------------------------- */

    /* Card style cho các block - Style Gen Z */
    ...
    /* Nút bấm kiểu Gen Z: Bo tròn + Gradient hồng phấn */
    ...
    /* Metric xịn xò màu đỏ san hô */
    [data-testid="stMetricValue"] {
        color: #FF6B6B;
        font-family: 'Comfortaa';
    }

    /* Chỉnh màu cho các tiêu đề */
    h1 { color: #FF6B6B !important; text-align: center; font-weight: 700; }
    h2, h3 { color: #5D5D5D !important; }
